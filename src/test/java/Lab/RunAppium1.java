...
public class RunAppium1 {
	...
	public void startServer() throws IOException {
		...
		cap.setCapability("deviceName", capabilitiesRepo.getProperty("1deviceName"));

		// Platform version
		cap.setCapability("platformVersion", capabilitiesRepo.getProperty("1platformVersion"));
